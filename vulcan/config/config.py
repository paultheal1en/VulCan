...
class LLMConfig(BaseFileSettings):
    ...
    server: str = "bedrock"  # 'bedrock', 'ollama', 'mistral', 'openai', 'gemini'
    # --- Cấu hình Bedrock ---
    ...
    openai_base_url: Optional[str] = None  # Cho các API tương thích OpenAI
    # --- Cấu hình Gemini (qua LiteLLM) ---
    gemini_api_key: Optional[str] = None
    gemini_model_id: str = "gemini/gemini-1.5-pro-latest"
