...
try:
    ...
    print(
        "Lỗi: Không tìm thấy thư viện 'PyMySQL'. Hãy đảm bảo bạn đã cài đặt nó: pip install PyMySQL"
    )
    engine = None
    SessionLocal = None
...
def session_scope() -> Session:
    ...
    if SessionLocal is None:
        raise RuntimeError(
            "Database session is not initialized. Check your PyMySQL installation and DB config."
        )
